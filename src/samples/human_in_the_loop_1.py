"""
This sample shows how to use human-in-the-loop to edit a generated summary.
Review & edit state
"""
...
def human_review_edit(state: State) -> State:
    result = interrupt(
        {"task": "Please review and edit the generated summary if necessary.", "generated_summary": state["summary"]}
    )
